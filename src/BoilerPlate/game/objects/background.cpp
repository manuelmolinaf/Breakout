...
namespace game
{
	namespace objects
	{
		...
		void background::attach_components()
		{
			float vertices[36] =
			{
				2.0f,  1.0f, 0.0f,  1.0f, 1.0f, 1.0f, 1.0f,   1.0f, 1.0f,  //0
				2.0f, -1.0f, 0.0f,  1.0f, 1.0f, 1.0f, 1.0f,   1.0f, 0.0f,  //1
				-2.0f,-2.0f, 0.0f,  1.0f, 1.0f, 1.0f, 1.0f,   0.0f, 0.0f,  //2 
				-2.0f, 2.0f, 0.0f,  1.0f, 1.0f, 1.0f, 1.0f,   0.0f, 1.0f,  //3
			};
